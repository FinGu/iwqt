...
QStringList AddEditWindow::supportedTypes(){
    return (QStringList() << "open" << "psk" << "8021x");
}

QStringList AddEditWindow::supportedEAPMethods(){
    return (QStringList() << "MSCHAPV2" << "PEAP" << "PWD" << "TLS" << "TTLS");
}

QStringList AddEditWindow::supportedPhase2Methods(){
    return (QStringList() << "MSCHAPV2" << "PEAP" << "PWD" << "TLS" << "TTLS");
}

void AddEditWindow::newWindow(){
...
void AddEditWindow::refreshWindow(){
...
AddEditWindow::AddEditWindow(const known_network *n, QWidget *parent): QDialog(parent){
    setMinimumWidth(300);
...
void AddEditWindow::fillUpFromNetwork(const known_network *n){
